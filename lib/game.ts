export interface Shrine {
  level: number;
  name: string;
  /** @deprecated Use ShrineSvgIcon component instead */
  emoji: string;
  score: number;
  color: string;
  bgColor: string;
...
export const SHRINES: Shrine[] = [
  { level: 1, name: "鳥居",     emoji: "",  score: 2,    color: "#ffffff", bgColor: "#ef4444", goryaku: "縁結び" },
  ...
  { level: 7, name: "大社",     emoji: "",  score: 128,  color: "#1a1a1a", bgColor: "#f59e0b", goryaku: "出世" },
