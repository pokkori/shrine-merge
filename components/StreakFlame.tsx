  ...
  return (
    ...
    >
      ...
      <svg
        ...
        viewBox="0 0 24 32"
        aria-hidden="true"
        style={{ animation: `flameWaveShrine ${speed}s ease-in-out infinite` }}
      >
        <defs>
          <linearGradient id="flameGradShrine" x1="0" y1="1" x2="0" y2="0">
